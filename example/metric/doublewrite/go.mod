module github.com/GoogleCloudPlatform/opentelemetry-operations-go/example/metric/doublewrite
...
require (
	...
	google.golang.org/genproto v0.0.0-20260406210006-25814544d977 // indirect
